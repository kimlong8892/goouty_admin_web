...
export default function TripTemplateForm({ initialData, id, provinces }: TripTemplateFormProps) {
    ...
    return (
        <div className="mx-auto max-w-7xl px-4 pb-20 sm:px-6 lg:px-8">
            ...
            <div className="sticky top-0 z-40 -mx-4 mb-10 border-b border-gray-200/50 bg-white/80 px-4 py-8 backdrop-blur-3xl dark:border-gray-800/50 dark:bg-gray-900/80 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div className="flex items-center gap-4">
                        <button
                            type="button"
                            onClick={() => router.back()}
                            className="rounded-2xl border border-gray-200 bg-white px-6 py-3.5 text-sm font-bold text-gray-600 transition-all hover:bg-gray-50 hover:text-gray-900 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 active:scale-95"
                        >
                            Hủy Thay đổi
                        </button>
                        <button
            ...
            <form id="template-form" onSubmit={handleSubmit} className="grid grid-cols-1 gap-10 lg:grid-cols-12">
                ...
                <div className="lg:col-span-12 space-y-10">
                    ...
                    <div className="overflow-hidden rounded-[2.5rem] border border-gray-100 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900">
                        <div className="bg-gray-50/50 px-8 py-6 dark:bg-gray-800/50 border-b border-gray-100 dark:border-gray-800">
                                ...
                                <div className="lg:col-span-7 space-y-6">
                                    <div className="group relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full rounded-2xl border-gray-100 bg-gray-50/50 px-5 py-4 text-gray-900 placeholder-gray-400 transition-all focus:bg-white focus:ring-2 focus:ring-brand-500/20 dark:border-gray-800 dark:bg-gray-800/50 dark:text-white dark:focus:bg-gray-800"
                                    ...
                                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                        <div className="space-y-2">
                                            ...
                                            <select
                                                ...
                                                className="w-full rounded-2xl border-gray-100 bg-gray-50/50 px-4 py-3.5 text-sm font-bold text-gray-900 transition-all focus:bg-white focus:ring-2 focus:ring-brand-500/20 dark:border-gray-700 dark:bg-gray-800 dark:text-white appearance-none cursor-pointer"
                                            >
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div className="relative group">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full rounded-2xl border-gray-100 bg-gray-50/50 py-3.5 pl-8 pr-4 text-sm font-bold text-gray-900 focus:bg-white focus:ring-2 focus:ring-brand-500/20 dark:border-gray-700 dark:bg-gray-800 dark:text-white"
                                                />
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center justify-between">
                            <div>
                                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Lịch trình Chi tiết</h2>
                                <p className="text-sm text-gray-500">Ghi lại hành trình theo từng ngày.</p>
                            </div>
                            <button
                                type="button"
                                onClick={addDay}
                                                                ...
                                                                >
                                                                    ...
                                                                    <div className="flex-1 space-y-4 pt-1">
                                                                        ...
                                                                        <div className="flex items-start justify-between">
                                                                            ...
                                                                            <div className="flex items-center gap-3">
                                                                                <label className="flex cursor-pointer items-center gap-2 rounded-full border border-gray-100 bg-white px-3 py-1 text-[10px] font-bold uppercase tracking-widest shadow-sm transition-all hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800">
                                                                                    <input
                                                                                        type="checkbox"
                                                                        ...
                                                                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                                                                            <div className="relative group/field">
                                                                                ...
                                                                                <input
                                                                                    ...
                                                                                    className="w-full rounded-xl border border-gray-100 bg-gray-50/50 py-2.5 pl-9 pr-3 text-xs font-bold focus:bg-white focus:ring-2 focus:ring-primary/20 dark:border-gray-700 dark:bg-gray-800"
                                                                                />
                                                                            </div>
                                                                            <div className="relative group/field">
                                                                                <div className="pointer-events-none absolute inset-y-0 left-3 flex items-center">
                                                                                ...
                                                                                <input
                                                                                    ...
                                                                                    className="w-full rounded-xl border border-gray-100 bg-gray-50/50 py-2.5 pl-9 pr-3 text-xs font-bold focus:bg-white focus:ring-2 focus:ring-brand-500/20 dark:border-gray-700 dark:bg-gray-800"
                                                                                />
                                                                            </div>
                                                                            <div className="relative group/field">
                                                                                <div className="pointer-events-none absolute inset-y-0 left-3 flex items-center">
